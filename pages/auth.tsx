            ...
            <div className='bg-black w-full h-full lg:bg-opacity-50'>
                ...
                <div className='flex justify-center'>
                    <div className='bg-black bg-opacity-70 px-16 py-16  self-center mt-2 lg:w-2/5 rounded-md w-full'>
                        ...
                        <p onClick={toggleVariant} className='text-neutral-500 mt-12'>Fist time using Netflix?
                            <span className='text-white ml-2 hover:underline cursor-pointer'>Create an account</span></p>
                    </div>
                </div>
